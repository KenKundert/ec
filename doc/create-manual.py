#!/usr/bin/env python3
# encoding: utf8
# Create the user and reference manuals.
...
def write(user_filename=None, reference_filename=None):
    for template, filename in zip(
        [user_manual, reference_manual],
        ...
        if filename:
            ...
            # generate reStructuredText file
            with open(filename, 'w') as outputFile:
                outputFile.write(rst)

if __name__ == '__main__':
    write('user.rst', 'reference.rst')

# -*- coding: utf-8 -*-
#
# Engineering Calculator documentation build configuration file, created by
...
copyright = u'2012-2020, Ken Kundert'
...
latex_documents = [
  ('index', 'ec.tex', u'Engineering Calculator Documentation',
...
man_pages = [
    ('index', 'ec', u'Engineering Calculator Documentation',
     [u'Ken Kundert'], 3)
]
...
texinfo_documents = [
  ('index', 'engineering_calculator', u'Engineering Calculator Documentation',
   u'Ken Kundert', 'Engineering Calculator', 'engineering calculator.',
   'Miscellaneous'),
]
